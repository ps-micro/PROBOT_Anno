...
from help_file import standard_fields as fields
...
def draw_bounding_box_on_image(image,
  ...
  #if(left > 150 and right < 506 and top > 21 and bottom < 329):
...
def visualize_boxes_and_labels_on_image_array(
  ...
  for box, color in box_to_color_map.items():
    ...
    #print("box_to_display_str_map[box]",box_to_display_str_map[box])
